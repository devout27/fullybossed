...
function save_Meeting_Data($Save_Meet_Data_arr) {
    global $wpdb;
    $table = $wpdb->prefix.'zoom_links';
    $data = array(
                'booking_id' => $Save_Meet_Data_arr['booking_id'],
                'topic' => $Save_Meet_Data_arr['topic'],
                'meeting_id' => $Save_Meet_Data_arr['meeting_id'],
                'start_time' => $Save_Meet_Data_arr['start_time'],
                'join_url' => $Save_Meet_Data_arr['join_url'],
                'password' => $Save_Meet_Data_arr['password'],
                );
...
function get_BookingDateTime($booking_id) {
    global $wpdb;
    $table = $wpdb->prefix.'dc_session_booking_dates';
    $querystr = "SELECT * FROM $table WHERE booking_id = $booking_id";
    $booking_posts = $wpdb->get_row($querystr, OBJECT);
