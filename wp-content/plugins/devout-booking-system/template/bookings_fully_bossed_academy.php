<?php
$url = home_url() . "/wp-admin/admin.php?page=bookings-fully-bossed-academy";
...
$lists = getBookingListByServiceId(FULLY_BOSSED_ACADEMY_SERVICE_ID);
?>
<div class="container">
	...
	<div class="fb-booking-tab-btns">
		<nav>
			<div class="nav nav-tabs" id="nav-tab" role="tablist">
				<a class="nav-item nav-link active" href="https://fullybossed.com/wp-admin/admin.php?page=bookings-fully-bossed-academy">Booking History</a>
				<a class="nav-item nav-link" href="https://fullybossed.com/wp-admin/admin.php?page=session">Manage Sessions</a>
			</div>
		</nav>
	</div>
...
echo !empty($list['session_name']) ? $list['session_name'] : 'NA';
        ?>
						...
						<td>
							...
							<a href="<?php echo home_url('/') ?>wp-admin/admin.php?page=bookings-fully-bossed-academy&action=delete&id=<?php echo $list['id'] ?>" onclick="return confirm('Are you sure you want to delete this booking?');">
