					...
					?>
						<tr>
							...
							<td>
								...
								<a href="<?php echo home_url('/')?>wp-admin/admin.php?page=download-history&action=delete&id=<?php echo $list['id']?>" onclick="return confirm('Are you sure you want to delete this download history?');">
