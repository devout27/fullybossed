	 ...
	 if($booking['status']==2 || $booking['status']==4){?>
          ...
          <hr style="width: 35%; margin: 10px auto; color: #a8d08d; border: none; height: 2px; background: #a8d08d;">
            ...
            <p style="line-height: 25.0px;display: block;margin: 0.0px 0.0px 20.0px 0.0px;color: rgb(51,51,51); color: #000; font-family: Gotham;">
              ...
              Transaction ID: <strong style="color: rgb(0,0,0); color: #000; float: right; font-weight: 600;"><?php echo $booking['transaction_id']?></strong><br>
              Travel Expenses: <strong style="color: rgb(0,0,0); color: #000; float: right; font-weight: 600;"><?php echo CURRENCYSYMBOL.number_format($booking['travel_expenses'], 2)?></strong> <br>
              Base Price For Event: <strong style="color: rgb(0,0,0); color: #000; float: right; font-weight: 600;"><?php echo CURRENCYSYMBOL.number_format($booking['base_price_for_event'], 2)?></strong><br>
              Service Charge: <strong style="color: rgb(0,0,0); color: #000; float: right; font-weight: 600;"><?php echo CURRENCYSYMBOL.number_format($booking['service_charge'], 2)?></strong>
			  <br>
        ...
        <hr style="width: 35%; margin: 10px auto; color: #a8d08d; border: none; height: 2px; background: #a8d08d;">
          ...
          <p style="line-height: 25.0px;display: block;margin: 0.0px 0.0px 20.0px 0.0px;padding: 0 0; color: rgb(51,51,51); color: #000; font-family: Gotham;">
            ...
            Total Hours: <strong style="color: rgb(0,0,0); color: #000; font-weight: 600; float: right;"><?php echo $total_booked_hours?></strong></p>
			<p>
			</p>
          </div>
          ...
          <hr style="width: 35%; margin: 10px auto; color: #a8d08d; border: none; height: 2px; background: #a8d08d;">
            ...
            <p style="line-height: 25.0px;display: block;margin: 0.0px 0.0px 20.0px 0.0px;color: rgb(51,51,51); color: #000; font-family: Gotham;">
			  ...
			  Address: <strong style="color: rgb(0,0,0) color: #000; float: right; ;font-weight: 600;"><?php echo $booking['location_description']?></strong><br>
			  Postal Code: <strong style="color: rgb(0,0,0) color: #000; float: right; ;font-weight: 600;"><?php echo $booking['postal_code']?></strong><br>
			  Country: <strong style="color: rgb(0,0,0) color: #000; float: right; ;font-weight: 600;"><?php echo $booking['country']?></strong><br>
