<html lang="en">
		...
		<div class="container" style="width: 600px; margin: 0 auto;">
		   ...
		   <div class="Dear" style="width: 602px; color: #000; background-color: #fff;  box-sizing: border-box; padding: 0 0px 0 30px; font-size: 18px; border: 1px solid #b5adad; border-top: none; border-bottom: none;">
			 <?php echo $body; ?>
		   </div>
