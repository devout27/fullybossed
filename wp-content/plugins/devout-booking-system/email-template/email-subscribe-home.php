<html lang="en">
		...
		<div class="container" style="width: 600px; margin: 0 auto;">
		   ...
		   <div class="Dear" style="width: 602px; color: #000; background-color: #fff;  box-sizing: border-box; padding: 0 0px 0 30px;padding-right: 30px;padding-left: 30px; border: 1px solid #b5adad; border-top: none; border-bottom: none;">
			 <?php echo $body; ?>
			...
			<p style="line-height: 25.0px;display: block;margin: 15px 0 10px 0;color: rgb(51,51,51); color: #000; font-family: Gotham;">Stay tuned. We’ll be in touch soon!<br> Team Fully Bossed.</p>
			</div>
			</div>
